  ...
  return (
    <SiteShell locale={locale} activePage="home">
      <section className="flex min-h-[60vh] flex-col items-center justify-center gap-6 text-center">
        ...
        <Link className="mt-4 inline-flex items-center gap-2 rounded-lg border border-accent bg-accent px-6 py-3 font-light tracking-wide text-white transition-all duration-250 hover:bg-accent-hover hover:shadow-lg" href={localizedPath(locale, '/')}>
